...
ok-nte is a Windows automation tool for *Neverness To Everness*. It interacts through screen recognition, OCR, system audio feedback, and ordinary keyboard and mouse input. It does not read game memory or modify game files.

## Get started

- [Installation](getting-started/installation.md)
- [Before you start](getting-started/configuration.md)
