        ...
        self.default_config.update(
            {
                ...
                self.CONF_ENGAGE_ATTACK: 0.1,
                self.CONF_DODGE_TEST: False,
                self.CONF_DODGE_STYLE: self.STYLE_CURRENT,
                self.CONF_D4_FRONT: 950,
                self.CONF_D4_JUMP_HOLD: 40,
                self.CONF_D4_BACK: 200,
                self.CONF_D4_CLICK_HOLD: 40,
                self.CONF_D4_CLICK_GAP: 8,
                self.CONF_D4_TAIL_DODGE: self.D4_DODGE_W,
                self.CONF_D4_TAIL_FILL: 350,
                self.CONF_FIRST_ATTACK_TEST_KEY: "4",
                ...
                self.CONF_LS_JUMP_AT: 1470,
                self.CONF_LS_JUMP_HOLD: 18,
                self.CONF_LS_CLICK_HOLD: 40,
                self.CONF_LS_CLICK_GAP: 8,
                self.CONF_LS_TAIL: 218,
